...
<?php
	...
	$consulta_sql = "SELECT * FROM poblaciones WHERE region=" . $sel . " ORDER BY poblacion";
	...
	{
?>
		<select id="poblacion" name="poblacion" onchange="carga_zonas(this.value,'');" class="campo_texto">
