<?php
	function insertar()
	{
		...
		// Datos del inmueble
		$sql = "SELECT * FROM contratos_compra_venta_inmueble WHERE id_contrato_compra_venta=".$_GET['contrato_compra_venta'];
		...
		$row_consulta['cantidad_parcial']=($contrato['precio']*PORCENTAJE_COMISION_FACTURAS_FRAMEWORK)/100;
		...
		// Interfaz
		include(PATHINCLUDE_FRAMEWORK_MEDIA_HTML.'clientes/contratos_compra_venta/facturas/insertar.php');
	}
?>
<?php
	function editar()
	{
		...
		$DB = new Model();
		// Datos del inmueble
		$sql = "SELECT * FROM facturas_contratos_compra_venta_inmueble WHERE contrato_compra_venta=".$_GET['contrato_compra_venta'];
		...
		$row_consulta['nif']=$cliente['nif'];
		// Interfaz
		include(PATHINCLUDE_FRAMEWORK_MEDIA_HTML.'clientes/contratos_compra_venta/facturas/editar.php');
	}
?>
<?php
	...
	{
		// Interfaz
		include(PATHINCLUDE_FRAMEWORK_MEDIA_HTML.'clientes/contratos_compra_venta/facturas/estas_seguro.php');
	}
?>