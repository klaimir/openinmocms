...
<?php
	...
	if($_POST)
	{
		...
		$_SESSION['s_busq_informes_tipologia_todos'] = $sql_todos;	
	...
	$_SESSION['display_pages_busq_informes_tipologia']=$pages->display_pages();
	$_SESSION['display_menu_pages_busq_informes_tipologia']='<span style="margin-left:25px"> '. $pages->display_jump_menu()  
. $pages->display_items_per_page() . '</span>';

	// Paginación en el sql
	$_SESSION['s_busq_informes_tipologia_todos'].=$sql_pagination_limit;
?>
<?php Interfaz::PlantillaGenerica("informes","informe_tipologia"); ?>
<?php
