...
?>
			<td>
				<?php if ($this->_tpl_vars['days']['exists'] == 1): ?><a <?php if ($this->_tpl_vars['days']['selected'] == 1): ?> class="selection" <?php endif; ?> href="javascript:pmvUrlOnChangeDay ('<?php echo $this->_tpl_vars['days']['date']; ?>
')"><?php endif; ?>
