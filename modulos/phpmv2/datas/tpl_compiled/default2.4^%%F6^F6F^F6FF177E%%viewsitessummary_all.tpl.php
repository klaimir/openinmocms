<?php /* Smarty version 2.6.9, created on 2013-04-12 08:14:49
         compiled from common/viewsitessummary_all.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'common/viewsitessummary_all.tpl', 1, false),array('modifier', 'string_format', 'common/viewsitessummary_all.tpl', 22, false),array('modifier', 'time_visit', 'common/viewsitessummary_all.tpl', 23, false),array('function', 'counter', 'common/viewsitessummary_all.tpl', 2, false),array('function', 'cycle', 'common/viewsitessummary_all.tpl', 18, false),)), $this); ?>
...
?>
<tr onmouseover="pointer(this)" onclick="loadUrl('<?php echo $this->_tpl_vars['url_mod_site']; ?>
...
align"  width="130px"><?php echo $this->_tpl_vars['info']['site_name']; ?>
	...
	<td class="<?php echo $this->_tpl_vars['style']; ?>
"><strong><?php echo $this->_tpl_vars['info']['nb_vis']; ?>
</strong></td>
	<td class="<?php echo $this->_tpl_vars['style']; ?>
...
<tr><?php echo smarty_function_cycle(array('values' => 'damierlight','assign' => 'style'), $this);?>
	...
	<td class="<?php echo $this->_tpl_vars['style']; ?>
"><strong>T<small>OTAL</small></strong></td>
	<td class="<?php echo $this->_tpl_vars['style']; ?>
