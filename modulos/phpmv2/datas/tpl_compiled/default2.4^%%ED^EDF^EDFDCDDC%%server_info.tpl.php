<?php /* Smarty version 2.6.9, created on 2013-04-12 08:10:37
         compiled from admin/server_info.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'admin/server_info.tpl', 4, false),)), $this); ?>
<?php $this->assign('ok', "<img src='".($this->_tpl_vars['PMV_THEME'])."/images/ok.gif' />");  $this->assign('error', "<img src='".($this->_tpl_vars['PMV_THEME'])."/images/no.gif' />");  $this->assign('warning', "<img src='".($this->_tpl_vars['PMV_THEME'])."/images/warning.gif' />"); ?>
...
<table class="infos">
	<tr>
		...
		<td><?php if ($this->_tpl_vars['server']['php_ok']):  echo $this->_tpl_vars['ok'];  else:  echo $this->_tpl_vars['error'];  endif; ?></td>
	</tr>
	<tr>
		<td class="libelle">Mysql extension</td>
		<td><?php if ($this->_tpl_vars['server']['mysql_ok']):  echo $this->_tpl_vars['ok'];  else:  echo $this->_tpl_vars['error'];  endif; ?></td>
	</tr>  
	<tr>
		<td class="libelle">PHP-XML extension (utf8_decode function)</td>
	    <td><?php if ($this->_tpl_vars['server']['php_xml']):  echo $this->_tpl_vars['ok'];  else:  echo $this->_tpl_vars['error'];  endif; ?></td>
	</tr>
	<tr>
		<td class="libelle">
...
?>
				<li>
				<?php if ($this->_tpl_vars['bool']):  echo $this->_tpl_vars['ok'];  else: ?>
...
<table class="infos">
	<tr>
	    ...
	    <td><?php if ($this->_tpl_vars['server']['gd_ok']):  echo $this->_tpl_vars['ok'];  else:  echo $this->_tpl_vars['warning'];  endif; ?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			<?php if ($this->_tpl_vars['server']['memory_ok']):  echo $this->_tpl_vars['ok'];  else:  echo $this->_tpl_vars['warning'];  endif; ?>	
	...
	<tr>
		...
		<td><?php if ($this->_tpl_vars['server']['set_time_limit_ok']):  echo $this->_tpl_vars['ok'];  else:  echo $this->_tpl_vars['warning'];  endif; ?></td>
	</tr>
	<tr>
		...
		<td><?php if ($this->_tpl_vars['server']['mail_ok']):  echo $this->_tpl_vars['ok'];  else:  echo $this->_tpl_vars['warning'];  endif; ?></td>
	</tr>
</table>
...
<?php endif;  echo ((is_array($_tmp='admin_legend')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
