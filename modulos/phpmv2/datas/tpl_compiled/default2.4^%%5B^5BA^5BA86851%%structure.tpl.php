...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'common/structure.tpl', 10, false),array('function', 'counter', 'common/structure.tpl', 26, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
		...
		<a href="./index.php">
		<img title="<?php echo ((is_array($_tmp='logo_description')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
" src="<?php echo $this->_tpl_vars['PMV_THEME']; ?>
images/phpmv.png" alt="phpMyVisites" width="485" height="132" />
		</a>
		<div class="both"></div>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<?php if ($this->_tpl_vars['mod'] == view): ?>
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "common/menu_pdf.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
