...
$lang['generique_aucune_visite_bdd'] = "<b>Upozorenje ! </b> U bazi nema zabilježenih posjeta za ovaj sajt. Provjerite da li ste postavili svoj Javascript kôd na svoje stranice s odgovarajućom putanjom do phpMyVisites aplikacije. Ili pretražite dokumentaciju za pomoć.";
...
$lang['generique_help_novisits'] = "Napomena: Jeste li %s instalirali javascript kôd %s na svoje stranice?";
...
$lang['pagesvues_help_pagename'] = "Jeste li znali da možete dati prepoznatljivo ime svojim stranicama?";
$lang['pagesvues_help_track_dls'] = "Jeste li znali da možete pratiti Downloade i vanjska URL preusmjeravanja?";
...
$lang['admin_site_select'] = "Sajt za administriranje";
...
$lang['admin_get_default_theme'] = "<i>Tema</i> za ovaj sajt:";
...
$lang['admin_user_oldPwd'] = "Stara lozinka"; 
$lang['admin_user_oldPwd_bad'] = "Stara lozinka je pogrešna."; 
...
$lang['admin_url_generate_download_link_example'] = "Downloadajte adresu datoteke ili redirekciju URL-a na vanjski sajt.";
$lang['admin_url_generate_title'] = "Preuzimanje datoteke / Redirekcija URL-a : Generator URL-a";
...
$lang['admin_url_generate_site_selection'] = "Izaberite sajt za koji želite brojati download datoteka ili izlazni promet.";
$lang['admin_url_generate_tag_selection'] = "Izaberite tag koji želite pratiti za download datoteka ili URL redirekciju."; 
$lang['admin_url_generate_enter_url'] = "Unesite punu putanju vanjskog URL-a koji želite pratiti u statistici:";
$lang['admin_url_generate_help_enter_url'] = "Pomoć: Mora biti u obliku '<b>http://www.vassajt.com/putanja/do/neke-datoteke.zip</b>' ili bilo koja URL adresa za preusmjeravanje oblika '<b>http://www.neki-drugi-sajt.com</b>'";
$lang['admin_url_generate_friendly_name'] = "Prepoznatljivo ime datoteke / URL koji će biti korišten i tablici za pregled stranica:"; 
$lang['admin_url_generate_help_friendly_name'] = "Pomoć: Možete grupirati 'datoteke / Url preusmjeravanja' u kategorije za bolji prikaz pregledanih stranica u odjeljku phpMyVisites aplikacije. Možete odvojiti kategoriju i datoteke ili URL preusmjeravanja sa znakom '<b>/</b>'. Npr, ime može biti '<b>download slika/Ljeto u Francuskoj</b>' ili '<b>Partneri/PHP.net - službena stranica</b>' : to će se grupirati u folder '<b>download slika</b>' ili u folder '<b>Partneri</b>' : to ćete vidjeti u folderima 'Pregledane stranice', odjeljku u phpMyVisites sučelju.";
$lang['admin_url_generate_result_url'] = "Ovdje je URL na koji možete kliknuti: ";
$lang['admin_url_generate_html_result'] = "Ako vam ovo pomaže, možete koristiti ovaj HTML link:";
$lang['admin_url_generate_html_onclick'] = "Ovdje je HTML koji koristi onclick event:";
$lang['admin_url_generate_image_legend'] = "Primjer pregledanih stranica s URL presumjeravanjima i downloadom datoteka:";
$lang['admin_site_link_javascript'] = "%s Sada trebate intalirati kod za praćenje na vaše stranice (copy/paste Javascript kôda). Kliknite za prikaz javascript kôda. %s";
$lang['admin_last_version'] = "Imate li zadnju verziju phpMyVisites aplikacije? (Preporučljivo!)";
$lang['admin_general_config_firstday'] = "Prvi dan u kalendaru?";
$lang['admin_default_language'] = "Pretpostavljeni jezik? <br/>To će također biti i glavni jezik za mailove.";
$lang['admin_back_statisitics'] = "Idi na statistiku"; 

//
// Pdf export
//
$lang['pdf_generate_link'] = "Generiraj PDF datoteku sa statistikom za sajt %s";
$lang['pdf_summary_generate_link'] = "Generiraj PDF datoteku sa statističkim sažetkom";
$lang['pdf_free_page'] = "Nova stranica";
$lang['pdf_free_chapter'] = "Naslov poglavlja";
$lang['pdf_page_break'] = "Prekid stranice";
$lang['pdf_page_summary'] = "Sažetak";
$lang['generique_pdfno'] = "PDF %s"; // Newsletter "version 2 announcement" 
$lang['admin_pdf_title'] = "PDF sajta"; 
$lang['admin_nopdf'] = "Nije pronađen PDF za ovaj sajt!";
$lang['admin_recorded_pdf'] = "Zapisane PDF datoteke:";
$lang['admin_pdf_add'] = "Dodaj PDF"; 
$lang['admin_pdf_mod'] = "Izmjeni PDF"; 
$lang['admin_pdf_del'] = "Izbriši PDF"; 
$lang['generique_pdf'] = "PDF";
$lang['pdf_lib_show_interest'] = "Niz s promjenama je prikazan";
$lang['pdf_lib_hide_interest'] = "Niz s promjenama je sakriven";
$lang['pdf_lib_show_all'] = "Detalji su prikazani"; 
$lang['pdf_lib_hide_all'] = "Podaci su ograničeni u veličini";
$lang['pdf_lib_edit_text'] = "Izmjeni ovaj tekst"; 
$lang['pdf_lib_need_at_least_one_page'] = "Prvo morate kreirati 'praznu stranicu'";
$lang['pdf_lib_can_not_add_chapter'] = "Ne možete postaviti element prije nego što kreirate novu stranicu.";
$lang['pdf_lib_pdf_name_mandatory'] = "Ime je obvezno"; 
$lang['pdf_lib_pdf_expand_all'] = "Otvori sve"; 
$lang['pdf_lib_pdf_collapse_all'] = "Zatvori sve";
$lang['pdf_create_from_interface'] = "Kreirajte personalizirano PDF izvješće!";
$lang['pdf_complete'] = "Kompletno PDF izvješće"; 
...
$lang['install_display_javascript_code'] = "Prikaži Javascript kôd";
...
$lang['install_js_code_text'] = "<p>Da bi ubrojali sve posjete, morate ubaciti javascript kôd na sve svoje stranice. </p><p> Vaše stranice ne moraju biti napravljene u PHP-u, <strong>phpMyVisites će raditi na svim tipovima stranica (bilo da se radi o HTML-u, ASP-u, Perl-u ili bilo kojem drugom jeziku).</strong> </p><p> Ovdje je kôd koji morate ubaciti: (copy/paste na sve svoje stranice) </p>";
...
$lang['install_end_text'] = "Budite sigurni da se vaš javascript kôd nalazi na svim stranicama i pričekajte vaše prve posjetitelje!";
