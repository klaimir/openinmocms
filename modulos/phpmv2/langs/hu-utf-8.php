...
$lang['auteur_email'] = "see at http://www.hirtek.hu"; // Translator's website
...
$lang['lang_libelle_en'] = "Hungarian"; // hungarian language name
...
$lang['generique_help_novisits'] = "Tipp: %s telepítve van a javascript kód %s az oldalakon?";
...
$lang['login_error_nopermission'] = "A megadott felhasználónak nincs semmilyen jogosultsága. Kérje meg az adminisztrátort, hogy módosítsa a jogait a phpMyVisites-ben.";
...
$lang['mail_sender_name'] = "Webstatisztika (Automatikus)";
...
$lang['visites_average_visits_per_day'] = "Átlagos látogatások naponta"; 
...
$lang['visites_pages'] = "%s oldal"; // 1-2 pages (graph)
...
$lang['pagesvues_help_pagename'] = "Tudtad, hogy adhatsz barátságos neveket is az oldalaknak?";
$lang['pagesvues_help_track_dls'] = "Tudtad, hogy a letöltéseket és a külső URL átirányításokat is követheted?";
...
$lang['admin_url_generate_download_link_example'] = "Fájl letöltési cím, vagy URL átirányítás egy külső weboldalra";
$lang['admin_url_generate_title'] = "Fájl letöltés / Url átirányítás : Url generátor";
$lang['admin_url_generate_intro'] = "A phpMyVisites megtudja számlálni a fájl letöltéseket, és a külső URL kattintásokat is. Ezek statisztikája az 'Oldal megtekintések' szekció alatt láthatóak.</p><p class='texte'> Ezt úgy tudod megvalósítani, hogy olyan URL-t használsz, amely egy phpmyvisites fájlra mutat. Az URL-t egy egyszerű űrlap eszköz segítségével tudod létrehozni a 'URL generálása' gomb megnyomásával.";
$lang['admin_url_generate_site_selection'] = "Válaszd ki azt a honlapot, amely számlálja a fájl letöltést, vagy az Url átirányítást.";
$lang['admin_url_generate_tag_selection'] = "Select the tag for which you want to count a file download or a URL redirection"; 
$lang['admin_url_generate_enter_url'] = "Add meg a teljes elérési útvonalat, amelyet számlálni szeretnél:";
$lang['admin_url_generate_help_enter_url'] = "Segítség: Ilyen formátumban '<b>http://www.weboldalneve.hu/file/brilliant-software.zip</b>' , vagy '<b>http://www.atiranyitott-oldal.hu</b>'";
$lang['admin_url_generate_friendly_name'] = "Barátságos fájl / URL , amely az oldal megtekintések táblában lesz látható:"; 
$lang['admin_url_generate_help_friendly_name'] = "Segítség: csoportosíthatod a 'fájl / Url átirányítást' a jobb megjelenítés érdekében. Elválasztani a kategóriákat, a fájlokat, vagy az Url átirányításokat a '<b>/</b>' karakterrel tudod. Például, a Név legyen '<b>fotóim letöltése/Nyár a Hortobágyon</b>' vagy '<b>Partnerek/PHP.net weboldal</b>' : csoportosítva lesznek a következő könyvtárakban: '<b>fotóim letöltése</b>' vagy '<b>Partnerek</b>' : ezeket fogod látni az 'Oldal megtekintések' között.";
$lang['admin_url_generate_result_url'] = "URL a linkeléshez: ";
$lang['admin_url_generate_html_result'] = "Ha ez hasznos neked, használhatod ezt a HTML Linket is:";
$lang['admin_url_generate_html_onclick'] = "Here is the HTML using onclick event:";
$lang['admin_url_generate_image_legend'] = "Példa az Oldal megtekintésekre:";
$lang['admin_site_link_javascript'] = "%s Most telepítened kell a követőt az oldalaidon (másold és illeszd be a Javascript kódot). Kattintson a kód megjelenítéséhez. %s";
$lang['admin_last_version'] = "A legfrissebb phpMyVisites-t használod? (Ajánlott!)";
$lang['admin_general_config_firstday'] = "A kalendárium első napja?";
$lang['admin_default_language'] = "Alapértelmezett nyelv? <br/>Ez lesz az alapértelmezett nyelv a levelekhez is.";
$lang['admin_back_statisitics'] = "Go to statistics"; 

//
// Pdf export
//
$lang['pdf_generate_link'] = "PDF statisztika prezentáció generálása erről az oldalról: %s";
$lang['pdf_summary_generate_link'] = "PDF statisztikai összefoglaló prezentáció generálása";
$lang['pdf_free_page'] = "Szabad új oldal";
$lang['pdf_free_chapter'] = "Szabad cím fejezet";
$lang['pdf_page_break'] = "Oldal felbontás";
$lang['pdf_page_summary'] = "összefoglalás";
$lang['generique_pdfno'] = "PDF %s"; // Newsletter "version 2 announcement" 
$lang['admin_pdf_title'] = "Weboldal PDF"; 
$lang['admin_nopdf'] = "Nincs pdf ehhez a weboldalhoz!";
$lang['admin_recorded_pdf'] = "Mentett PDF:";
$lang['admin_pdf_add'] = "PDF hozzáadás"; 
$lang['admin_pdf_mod'] = "PDF módosítás"; 
$lang['admin_pdf_del'] = "PDF törlés"; 
...
$lang['install_DirectoriesWriteError'] = "<b>Probléma! </b><br/>Nem írható könyvtár(ak) %s Ellenőrizd le, hogy a megfelelő jogokkal rendelkezel a fájl készítéshez (CHMOD 755-re módosítsd a könyvtárat az FTP programoddal : jobb egérgomb a mappán -> Engedélyek (vagy CHMOD). <br/><br/>Ha a CHMOD nem működik a szoftvereddel, próbáld meg törölni (ha létezik) a könyvtárakat, és hozzd létre őket.";
