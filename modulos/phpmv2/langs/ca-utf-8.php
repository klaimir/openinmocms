...
//
$lang['auteur_nom'] = "Daniel Olivares Giménez, Siegfried-Angel Gevatter Pujals (RainCT)";
$lang['auteur_email'] = "dani88elx@gmail.com, webmaster@eurion.net";
...
$lang['lang_libelle_fr'] = "Catalan"; // idioma en francès
...
// HTML Markups
//
$lang['head_titre'] = "phpMyVisites | Aplicació lliure i gratuïta de gestió d'estadístiques i mesura d'audiència de llocs web"; // títol de les  pàgines d'estadístiques en l'header html
...
$lang['head_description'] = "phpMyVisites | Aplicació d'estadístiques i mesura d'audiència de llocs web | Programa gratuït i open source distribuït sota llicència GPL, desenvolupat en PHP i MySQL"; // Descripció en l'header html 
$lang['logo_description'] = "phpMyVisites: Programa gratuït d'estadístiques de pàgines web"; // descripció per al codi JS: anar al gra
...
$lang['liens_siteofficiel'] = "Pàgina web oficial";
$lang['liens_admin'] = "Administració";
...
$lang['generique_ok'] = "D'acord";
$lang['generique_timefooter'] = "Pàgina generada en %s segons"; // temps en segons
$lang['generique_divers'] = "Altres"; // (per als gràfics)
$lang['generique_inconnu'] = "Desconegut"; // (per als gràfics)
$lang['generique_vous'] = "... Tu?";
$lang['generique_traducteur'] = "Traductor";
$lang['generique_langue'] = "Llengua";
$lang['generique_autrelangure'] = "Altres?"; // Autre langue, Appel à contribution
$lang['aucunvisiteur_titre'] = "No hi ha hagut visites durant aquest període"; 
$lang['generique_aucune_visite_bdd'] = "<b>Atenció!</b> No hi ha cap visita a la base de dades. Assegura't que has posat el codi Javascript correctament en totes les pàgines. Consulta la documentaci&oacute;, si ho necessites.";
$lang['generique_aucune_site_bdd'] = "No hi ha cap pàgina web registrada a la base de dades. Intenta accedir com a super-usuari al phpMyVisites per afegir un altre lloc web.";
$lang['generique_retourhaut'] = "Amun";
$lang['generique_tempsvisite'] = "%smin %ss"; // 3min 25s means 3 minutes and 25 seconds
$lang['generique_tempsheure'] = "%sh"; // 4h means 4 hours
$lang['generique_siteno'] = "Pàgina %s"; // Site "phpmyvisites"
$lang['generique_newsletterno'] = "Butlletí %s"; // Newsletter "versió 2 announcement"
$lang['generique_partnerno'] = "Associat %s"; // Partner "versió 2 announcement"
...
$lang['generique_logout'] = "Tanca la sessió";
$lang['generique_login'] = "Inicia sessió";
$lang['generique_hits'] = "Impactes (hits)";
$lang['generique_errors'] = "Errors";
$lang['generique_site'] = "Pàgina";
$lang['generique_help_novisits'] = "Consell: Has posat el codi javascript %s a les teves pàgines?";

//
// Authentication
//
$lang['login_password'] = "Clau d'accés:"; 
$lang['login_login'] = "Nom d'usuari:"; 
$lang['login_error'] = "El nom d'usuari o la clau d'accés és incorrecte.";
$lang['login_error_nopermission'] = "L'usuari especificat no té cap permís. Demana al super-administrador que t'autoritzi per veure les estadístiques de la teva web.";
...
$lang['contacts_auteur'] = "L'autor de l'aplicació, la documentació i el creador del projecte phpMyVisites és <strong>Matthieu Aubry</strong>.";
$lang['contacts_questions'] = "Per a tota <strong>pregunta tècnica, informe d'errades, o suggestió</strong>, <strong>visita els fòrums</strong> a la pàgina oficial %s. Per a les altres peticions, contacta l'autor mitjançant el formulari de la pàgina oficial."; // adreça del lloc
$lang['contacts_trad1'] = "Vols utilitzar phpMyVisites en un altre idioma? Pots contribuir a la traduccions de l'aplicació, <strong>phpMyVisites et necessita!</strong>";
$lang['contacts_trad2'] = "Traduir el phpMyVisites necessites el seu temps (algunes hores) i requereix el perfecte domini d'ambdós llengues; però <strong>el teu treball serà útil a nombroses persones</strong>, que podran gaudir plenament del phpMyVisites. Si estas interessat en traduir el phpMyVisites, pots trobar tota l'informació necessària a %s la documentació oficial del phpMyVisites %s."; // vincle cap a la doc
$lang['contacts_doc'] = "No dubtis a consultar %sla documentació oficial de phpMyVisites%s. Et donarà molta informacions sobre l'instal·lació, la configuració i les funcionalitats del phpMyVisites. Està disponible directament a la teva còpia del phpMyVisites."; // vincle cap a la doc
$lang['contacts_thanks_dev'] = "Gràcies a <strong>%s</strong>, co-desenvolupadors de phpMyVisites, per la gran qualitat de treball que han fet per al projecte.";
$lang['contacts_merci3'] = "No dubtis a consultar la pàgina d'agraïments al lloc oficial de phpMyVisites per a tenir una llista més completa dels amics d'aquesta aplicació.";
$lang['contacts_merci2'] = "Un gran agraïment també a tots els que han compartit la seva cultura en traduir phpMyVisites:";

//
// Rss & Mails
//
$lang['rss_titre'] = "Pàgina %s' el %s"; // Site MyHomePage on Sunday 29 
$lang['rss_go'] = "Veure estatístiques més detallades";
$lang['mail_sender_name'] = "Estadístiques de la pàgina web (missatge automàtic)";
...
$lang['visites_pagesvisitessign'] = "Pàgines per visita significant"; 
$lang['visites_tempsmoyen'] = "Duració mitjana de les visites";
$lang['visites_tempsmoyenpv'] = "Mitja del temps de visualització per pàgina";
...
$lang['visites_aucunevivisite'] = "Cap visitat"; // en un quadre, anar al gra 
...
$lang['visites_graphtempsvisitesimg'] = "Durada de les visites per visitant";
$lang['visites_graphheureserveur'] = "Gràfic de visites per hora del servidor";
$lang['visites_graphheureserveurimg'] = "Visitants per hora del servidor";
...
// Sites Summary
//
$lang['summary_title'] = "Resum de la pàgina";
$lang['summary_stitle'] = "Resum";

//
// Frequency Part
//
$lang['frequence_titre'] = "Visitants que tornen";
$lang['frequence_nouveauxconnusgraph'] = "Gràfica que mostra els visitants que tornen i els que no";
...
$lang['pagesvues_pagesvudiff'] = "Pàgines úniques vistes";
...
$lang['pagesvues_help_pagename'] = "Sabies que pots donar un nom amigable a les teves pàgines?";
$lang['pagesvues_help_track_dls'] = "Sabies que pots comptar descàrregues i redireccions a pàgines externes?";

//
// Follows-Up
//
$lang['suivi_titre'] = "Seguiment del visitant";
$lang['suivi_pageentree'] = "Pàgines d'origen";
...
$lang['suivi_singlepage'] = "Visites d'una sola pàgina";

//
// Origin
//
$lang['provenance_titre'] = "Procedència dels visitants";
$lang['provenance_recappays'] = "Resum del països";
$lang['provenance_pays'] = "País";
$lang['provenance_paysimg'] = "Gràfic de països dels visitants";
$lang['provenance_fai'] = "Proveïdors d'accés a internet";
...
// Setup
//
$lang['configurations_titre'] = "Configuracions dels visitants";
$lang['configurations_os'] = "Sistema Operatiu";
$lang['configurations_osimg'] = "Gràfic dels S.O. dels visitant";
$lang['configurations_navigateurs'] = "Navegadors";
$lang['configurations_navigateursimg'] = "Gràfica dels navegadors dels visitant";
$lang['configurations_resolutions'] = "Resolució de la pantalla";
$lang['configurations_resolutionsimg'] = "Gràfic de les resolucions dels visitant";
$lang['configurations_couleurs'] = "Colors";
$lang['configurations_couleursimg'] = "Gràfic dels colors dels visitant";
$lang['configurations_rapport'] = "Pantalla ample / normal";
$lang['configurations_large'] = "Pantalla ample";
...
$lang['affluents_sitesimg'] = "Altres webs";
$lang['affluents_moteursimg'] = "Cercador";
$lang['affluents_referrersimg'] = "Referents";
$lang['affluents_moteurs'] = "Motors de cerca";
...
$lang['affluents_nbmotscles'] = "Nombre de paraules claus diferentes: %s";
$lang['affluents_aucunmotscles'] = "No s'ha trobat cap paraula clau.";
$lang['affluents_sitesinternet'] = "Pàgines web";
$lang['affluents_nbautressites'] = "Nombre de visitants que han arribat al lloc gràcies a vincles en un altre pàgina web: %s";
$lang['affluents_nbautressitesdiff'] = "Nombre de webs diferentes: %s";
$lang['affluents_aucunautresite'] = "Cap visitant ha arribat al lloc gràcies a un altre pàgina web.";
$lang['affluents_entreedirecte'] = "Entrades directes";
$lang['affluents_nbentreedirecte'] = "Nombre de visitants que han entrat directament al lloc: %s";
...
$lang['affluents_nbnewsletters'] = "Visitants provinents de butlletins: %s";
$lang['affluents_aucunnewsletter'] = "Cap visitant ha arribat des d'un butlletí";
$lang['affluents_details'] = "Detalls"; // al quadre davall els resultats de llocs referrers
$lang['affluents_interetsmoteurs'] = "Rànquing de motors de búsqueda";
$lang['affluents_interetsmotscles'] = "Rànquing de paraules clau";
$lang['affluents_interetssitesinternet'] = "Rànquing de pàgines web";
$lang['affluents_partenairesimg'] = "Afiliats";
$lang['affluents_partenaires'] = "Afiliats";
$lang['affluents_interetspartenaires'] = "Rànquing d'afiliats";
$lang['affluents_newslettersimg'] = "Notícies";
$lang['affluents_newsletters'] = "Notícies";
$lang['affluents_interetsnewsletters'] = "Rànquing de butlletins";
$lang['affluents_type'] = "Tipus de referent";
$lang['affluents_interetstype'] = "Rànquin dels tipus d'accés";
...
$lang['admin_purge'] = "Manteniment de la base de dades";
$lang['admin_purgeintro'] = "Aquesta secció et permet gestionar les dades de phpMyVisites. Pots consultar la mida de les taules, optimitzar-les, o esborrar-ne. Això et permet limitar la mida de les dades a la base de dades.";
$lang['admin_optimisation'] = "Optimització de [ %s ]..."; // nom de les taules
$lang['admin_postopt'] = "La mida total ha disminuït %chiffres% %unites%"; // Ex : 28 KO
$lang['admin_purgeres'] = "Esborrar els períodes següents: %s";
$lang['admin_purge_fini'] = "Final de l'operació d'eliminació de taules...";
$lang['admin_bdd_nom'] = "Nom";
$lang['admin_bdd_enregistrements'] = "Dades";
$lang['admin_bdd_taille'] = "Mida de la taula";
...
$lang['admin_purge_cal'] = "Calcular i eliminar (això pot trigar alguns minuts)";
$lang['admin_alias_title'] = "Àlies de la web i adreçes";
$lang['admin_partner_title'] = "Afiliats";
$lang['admin_newsletter_title'] = "Títol del butlletí";
$lang['admin_ip_exclude_title'] = "Rang d'IP a excloure de les estatístiques";
$lang['admin_name'] = "Nom:";
$lang['admin_error_ip'] = "Format d'IP incorrecte: %s";
$lang['admin_site_name'] = "Nom de la pàgina web";
$lang['admin_site_url'] = "Adreça de la pàgina web";
$lang['admin_db_log'] = "Prova de accedir al phpMyVisites com a super-usuari per canviar les propietats de la base de dades.";
$lang['admin_error_critical'] = "Error crític. És necessari arreglar-lo per que funcioni el phpMyVisites.";
$lang['admin_warning'] = "phpMyVisites funcionarà correctament; no obstant, algunes de les funcionalitats addicionals poden no fer-ho.";
...
$lang['admin_group_title'] = "Gestió dels grups (permissos)";
...
// Pdf export
//
$lang['pdf_generate_link'] = "Genera un arxiu PDF amb totes les estadístiques per la pàgina %s";
$lang['pdf_summary_generate_link'] = "Genera un PDF amb un resum de les estadístiques";
$lang['pdf_free_page'] = "Nova pàgina lliure";
$lang['pdf_free_chapter'] = "Títol de capítol lliure";
$lang['pdf_page_break'] = "Page break";
$lang['pdf_page_summary'] = "Resum";
$lang['generique_pdfno'] = "PDF %s";
$lang['admin_pdf_title'] = "Pàgina web PDF"; 
$lang['admin_nopdf'] = "No s'ha trobat cap PDF per aquesta pàgina!";
$lang['admin_recorded_pdf'] = "PDFs gravats:";
$lang['admin_pdf_add'] = "Afegueix un PDF"; 
$lang['admin_pdf_mod'] = "Modifica un PDF"; 
$lang['admin_pdf_del'] = "Esborra un PDF"; 
...
$lang['update_jschange'] = "Atenció! El codi javascript dle phpMyVisites s'ha modificat. Has d'actualitzar-lo a totes les pàgines.";
