<h1>{'contacts_titre'|translate}</h1>

<p class="texte">{'contacts_auteur'|translate}</p>
<p class="texte">{'contacts_questions'|translate:$link_forums}</p>
<p class="texte">{'contacts_doc'|translate:$link_doc}</p>

<h1>{'contacts_merci'|translate}</h1>
<p class="texte">{'contacts_thanks_dev'|translate:"Christophe (PDF Generation, Plugins, etc.), Marc (XHTML/CSS, General), Xavier (Smarty, General),  Jarda (bug fix & other features), All beta testers!"}</p>
<p class="texte">{'contacts_merci3'|translate}</p>
<p class="texte">{'contacts_merci2'|translate}</p>

<div class="centrer">
{include file="common/translators_array.tpl"}
<p>
