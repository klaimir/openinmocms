...
<img src="{$url_mod}&amp;mod=view_graph&amp;graph_type=5&amp;graph_data=frequency_new_vs_returning" alt="" />
{counter name=a}
<a id="a{$a}"></a>
<h3>{'pagesvues_vispervisgraph'|translate}</h3>
<img src="{$url_mod}&amp;mod=view_graph&amp;graph_type=2&amp;graph_data=visits_by_visitor" alt="" />
</div>
