...
// $Id: installSql.php 215 2007-05-01 13:03:34Z matthieu_ $
...
"CREATE TABLE ".DB_TABLES_PREFIX.'site'." (
  ...
  path_theme varchar(255) NOT NULL default 'default' ,
  PRIMARY KEY  (idsite)
) TYPE=MyISAM
";
...
$create['pdf_config'] = 
"CREATE TABLE ".DB_TABLES_PREFIX.'pdf_config'." (
...
$create['pdf_site_user'] = 
"CREATE TABLE ".DB_TABLES_PREFIX.'pdf_site_user'." (
  `idsite` int(10) unsigned NOT NULL default '0',
  `login` varchar(20) NOT NULL default '0',
...
"CREATE TABLE ".DB_TABLES_PREFIX.'plugin_version'." (
