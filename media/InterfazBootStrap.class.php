...
{	
	...
	public static function OpcionesExtras()
	{
		...
		// Interfaz
		include(PATHINCLUDE_FRAMEWORK_MEDIA_HTML.'_template_bootstrap/opciones_extras.php');
	}
	...
	public static function Cabecera()
	{
		...
		$sesion_iniciada=$session->SesionIniciada();
		// Interfaz
		include(PATHINCLUDE_FRAMEWORK_MEDIA_HTML.'_template_bootstrap/cabecera.php');
	}
	...
	public static function Menu($seccion)
	{
		...
		// Interfaz
		include(PATHINCLUDE_FRAMEWORK_MEDIA_HTML.'_template_bootstrap/menu.php');
	}
	...
	{
		// Interfaz
		include(PATHINCLUDE_FRAMEWORK_MEDIA_HTML.'_template_bootstrap/imagen.php');
	}
	...
	public static function Pie()
	{
		...
		// Interfaz
		include(PATHINCLUDE_FRAMEWORK_MEDIA_HTML.'_template_bootstrap/pie.php');
	}
	...
	{
		// Interfaz
		include(PATHINCLUDE_FRAMEWORK_MEDIA_HTML.'_template_bootstrap/plantilla_interfaz_generica.php');
	}
	...
	{
		// Interfaz
		include(PATHINCLUDE_FRAMEWORK_MEDIA_HTML.'_template_bootstrap/plantilla_interfaz_login.php');
	}
}
?>