		...
		<?php
			...
			if ($_POST)
			{
				if($_SESSION['hayerroresasignarfotos'])
				{
		?>
					<div class="titulo_errores"><strong>Informe de errores</strong> &nbsp;| &nbsp;<?php echo  count($_SESSION['erroresasignarfotos']); ?> error(es) encontrado(s)</div>
					<div class="detalle_errores">
					<ul class="lista_errores">
		<?php
					foreach($_SESSION['erroresasignarfotos'] as $error)
					{
		?>		
