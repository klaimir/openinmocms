		...
		<div class="regla_horizontal_superior">
			<div style="float:left;">
				<!-- Generar presupuesto -->
				<a href="#" onclick="document.editar.submit();return false"><img id="boton_inserta_bd" alt="Insertar en BD" name="boton_inserta_bd" border="0" src="<?php echo  $_SESSION['rutaimg'];?>actualizar.gif" align="absmiddle" /></a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="document.editar.submit();return false">Generar presupuesto</a>
			</div>
		...
		{
			// Control de errores
			if($_SESSION['hayerroreseditarpresupuesto'])
			{
	?>
				<div class="titulo_errores"><strong>Informe de errores</strong> &nbsp;| &nbsp;<?php echo  count($_SESSION['erroreseditarpresupuesto']); ?> error(es) encontrado(s)</div>
				<div class="detalle_errores">
				<ul class="lista_errores">
	<?php
				foreach($_SESSION['erroreseditarpresupuesto'] as $error)
				{
	?>		
