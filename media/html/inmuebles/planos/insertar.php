		...
		<?php
			...
			if ($_POST)
			{
				if($_SESSION['hayerroresasignarplanos'])
				{
		?>
					<div class="titulo_errores"><strong>Informe de errores</strong> &nbsp;| &nbsp;<?php echo  count($_SESSION['erroresasignarplanos']); ?> error(es) encontrado(s)</div>
					<div class="detalle_errores">
					<ul class="lista_errores">
		<?php
					foreach($_SESSION['erroresasignarplanos'] as $error)
					{
		?>		
		...
		<!-- Fichero -->
		<span style="text-align:right">Fichero (<?php echo  MAXTAM_FICHADJUNT;?>Mb. MAX.) (*): </span>
		<input class="campo_texto" type="file" id="fichero" name="fichero" size="55px" title="Fichero (<?php echo  MAXTAM_FICHADJUNT;?>Mb. MAX.)" onchange="modificado=true">
		<br />
		<p align="center">
