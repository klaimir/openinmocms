		...
		<?php
			...
			if ($_POST)
			{
				if($_SESSION['hayerroresrecomendaramigo'])
				{
		?>
					<div class="titulo_errores"><strong><?php echo  $textos['informe_errores']; ?></strong> &nbsp;| &nbsp;<?php echo  count($_SESSION['erroresrecomendaramigo']); ?> <?php echo  $textos['errores_encontrados']; ?></div>
					<div class="detalle_errores">
					<ul class="lista_errores">
		<?php
					foreach($_SESSION['erroresrecomendaramigo'] as $error)
					{
		?>		
		...
		<br  /><br  />
		<!-- Correo Amigo/a -->
		<span style="text-align:left;"><?php echo  $campos['correo_amigo']; ?>:  </span>
		<br  />
		<input class="campo_texto" name="correo_amigo" id="correo_amigo" size="50" title="<?php echo  $campos['correo_amigo']; ?>" value="<?php if($_POST['correo_amigo']) echo $_POST['correo_amigo']; ?>" >		
		<br  /><br  />
		<!-- Mensaje -->
		...
		<br  /><br  />
		<!-- Aceptar documentos -->
		<input name="aceptar_documentos" value="1" id="aceptar_documentos" type="checkbox" <?php if ($_POST['aceptar_documentos']) echo "checked"; ?>>&nbsp;&nbsp;<?php echo  $campos['aceptar_documentos']; ?>: <a target="_blank" href="condiciones_uso.php" title="Condiciones de uso"><?php echo  $campos['condiciones_uso']; ?></a>, <a target="_blank" href="politica_privacidad.php" title="Política de privacidad"><?php echo  $campos['politica_privacidad']; ?></a>
		<br  /><br  />
		<p align="left">
