    ...
    <div class="row">
        <!--
        <div class="modal fade" id="SearchHelp" role="dialog" aria-labelledby="SearchHelpLabel" aria-hidden="True">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title" id="SearchHelpLabel">Qué isite, Juan?</h2>
                    </div>
                    <div class="modal-body">
                    	<p align="left" style="margin-left:10px; margin-right:10px"><img src="<?php echo  $_SESSION['rutaimg'];?>bullet_enlaces.gif" align="absmiddle" />&nbsp;&nbsp;<?php echo  $textos['observaciones']; ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <ol class="breadcrumb">
                <li><a href="<?php echo  URL_EMPRESA; ?>"><?php echo  NOMBRE_EMPRESA; ?></a></li>
                <li class="active"><?php echo  $textos['titulo_seccion']; ?></li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-md-3">
            ...
            <h2><small><?php echo  $textos['titulo_seccion']; ?></small>
                <a data-toggle="modal" data-target="#SearchHelp"> <span class="glyphicon glyphicon-info-sign" style="font-size: 18px;"></span></a>
            </h2>
            <div style="width:100%">
