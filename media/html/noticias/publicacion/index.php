		...
		&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<span class="sin_enlace">Publicación de Noticias</span></div>
        <p align="justify" class="titulo_seccion">Publicación de Noticias</p>
		<p align="justify">
	...
	?>                
	  <form action="index.php" name="formulario" id="formulario" method="post" enctype="multipart/form-data">
			...
			<input class="campo_texto" name="titulo" id="titulo" type="text" size="100" title="Título" value="<?php if($_POST) { echo $_POST['titulo']; } else { echo $_SESSION['titulo_busq_noticias']; } ?>" style="margin-left:20px" onchange="modificado=true" />
...
<?php        
		// FIN FILTRO BÚSQUEDAS
		// ------------------------------------------------------------------------------------
?>
		<!-- Resultados de Búsqueda -->					
		<div style="width:100%; padding-bottom:2px; border-bottom:1px solid #666666; color:#003366">
			<div style="width:30%; float:left; text-align:left">
				<img src="<?php echo  $_SESSION['rutaimg'];?>oficina.gif" align="absmiddle" />&nbsp;Información sobre noticias registrados
			</div>	
	...
	<?php
		...
		{
	?>
    		<p align="justify"><img src="<?php echo $_SESSION['rutaimg'];?>info.gif" align="absmiddle">&nbsp;&nbsp;Actualmente no hay ninguna noticia registrada en el sistema con los criterios de búsqueda seleccionados.</p>
   <?php
		}
	?>
		<!--  Navegacion -->	
