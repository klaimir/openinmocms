		...
		&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<a href="index.php">Publicación de Noticias</a>&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<span class="sin_enlace">Publicar noticia</span></div>
		...
		<p align="justify"><img align="absmiddle" src="<?php echo $_SESSION['rutaimg']; ?>pregunta.gif">
			...
			{
			?>
			¿Estás seguro de que deseas publicar la noticia seleccionada?
			<?php 
			}
			else
			{
			?>
			¿Estás seguro de que deseas quitar la publicación de la noticia seleccionada?
			<?php 
			}
			?>
		</p>
