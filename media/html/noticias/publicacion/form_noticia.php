		<!-- DATOS DE USUARIO-->
		<p align="justify" class="titulo_seccion_datos">Datos de noticia</p>
		<div style="float:left; margin:0 auto; text-align:left; width:50%;">
			...
			<br  /><br  />
			<!-- Publicar -->
			<span style="text-align:left;">Publicar: </span>
			<br />
			<input name="publicar" value="1" id="publicar" type="checkbox" <?php if ($_POST['publicar']) echo "checked"; else {if($row_consulta['publicar'] == 1) echo "checked";} ?>>
		</div>
