		<a name="top"></a>
		<div class="breadcrumbs_publico"><img src="<?php echo  $_SESSION['rutaimg'];?>flecha1.png" align="absmiddle" />&nbsp;<a href="<?php echo  URL_EMPRESA; ?>"><?php echo  NOMBRE_EMPRESA; ?></a>&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<a href="<?php echo $_SESSION['rutaraiz']; ?>/app/acceso/index.php">Acceso</a>&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<a href="../index.php">Clientes</a>&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<a href="../editar.php?id=<?php echo  $_GET['id']; ?>">Editar</a>&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<span class="sin_enlace">Buscador de inmuebles</span></div>
	...
	?>                
        <form action="index.php?id=<?php echo  $_GET['id']; ?>" name="formulario" id="formulario" method="post" enctype="multipart/form-data">
			<!-- Provincia -->
			<span style="text-align:left; float:left;">Provincia: </span>
			<select id="provincia" name="provincia" onchange="carga_regiones_agente(this.value,''); carga_poblaciones_agente('',''); carga_zonas('','');" class="campo_texto" style="margin-left:10px; float:left;">
			<option value="" <?php if ($_POST) { if ($_POST['provincia'] == '') echo "selected"; } else { if (!isset($_SESSION['provincia_busq_gest_inmuebles_clientes'])) echo "selected"; else { if ($_SESSION['provincia_busq_gest_inmuebles_clientes'] == '') echo "selected"; } } ?>>Selecciona provincia ...</option>
			<?php
				do
				{
			?>
					<option <?php if ($_POST) { if ($_POST['provincia'] == $provincia['id_provincia']) echo "selected"; } else { if (isset($_SESSION['provincia_busq_gest_inmuebles_clientes'])) if ($_SESSION['provincia_busq_gest_inmuebles_clientes'] == $provincia['id_provincia']) echo "selected"; } ?> value="<?php echo  $provincia['id_provincia'];?>"><?php echo  $provincia['provincia'];?></option>
			<?php
			...
			<!-- Municipio -->
			<span style="text-align:left; float:left; margin-left:10px;">Municipio: </span>
			...
			<input class="campo_texto" name="palabras" id="palabras" type="text" size="130" title="Palabra(s) clave" value="<?php if ($_POST) { if ($_POST['palabras']) echo $_POST['palabras']; } else { if (isset($_SESSION['palabras_busq_gest_inmuebles_clientes'])) echo $_SESSION['palabras_busq_gest_inmuebles_clientes']; } ?>">
			<!-- Opciones -->
			...
			<select id="opciones" name="opciones" class="campo_texto" onchange="modificado=true" style="margin-left:10px;">
				<option value="" <?php if ($_POST) { if ($_POST['opciones'] == '') echo "selected"; } else { if (!isset($_SESSION['opciones_busq_gest_inmuebles_clientes'])) echo "selected"; else { if ($_SESSION['opciones_busq_gest_inmuebles_clientes'] == '') echo "selected"; } } ?>>Seleccione opción ...</option>
			<?php
				do
				{
			?>
					<option <?php if ($_POST) { if ($_POST['opciones'] == $opcion['id_opcion']) echo "selected"; } else { if (isset($_SESSION['opciones_busq_gest_inmuebles_clientes'])) if ($_SESSION['opciones_busq_gest_inmuebles_clientes'] == $opcion['id_opcion']) echo "selected"; } ?> value="<?php echo  $opcion['id_opcion'];?>"><?php echo  $opcion['nombre_opcion'];?></option>	
			<?php
		...
		<div style="width:100%; padding-bottom:2px; border-bottom:1px solid #666666; color:#003366">
			<div style="width:50%; float:left; text-align:left">
				<!-- Ordenación -->	
				<span>Criterios de ordenación del buscador:</span>
			</div>
			<div style="width:50%; float:right; text-align:right">
				<span style="margin-left:15px">Metros</span>&nbsp;&nbsp;
				<a href="index.php?id=<?php echo  $_GET['id'] ;?>&campo=metros&orden=asc#listado"><img border="0" src="<?php echo  $_SESSION['rutaimg'];?>asc_azul.gif" align="absmiddle" /></a>&nbsp;<a href="index.php?id=<?php echo  $_GET['id'] ;?>&campo=metros&orden=desc#listado"><img border="0" src="<?php echo  $_SESSION['rutaimg'];?>desc_azul.gif" align="absmiddle" /></a>
				<span style="margin-left:15px">Precio compra</span>&nbsp;&nbsp;
				<a href="index.php?id=<?php echo  $_GET['id'] ;?>&campo=precio_compra&orden=asc#listado"><img border="0" src="<?php echo  $_SESSION['rutaimg'];?>asc_azul.gif" align="absmiddle" /></a>&nbsp;<a href="index.php?id=<?php echo  $_GET['id'] ;?>&campo=precio_compra&orden=desc#listado"><img border="0" src="<?php echo  $_SESSION['rutaimg'];?>desc_azul.gif" align="absmiddle" /></a>
				<span style="margin-left:15px">Precio alquiler</span>&nbsp;&nbsp;
				<a href="index.php?id=<?php echo  $_GET['id'] ;?>&campo=precio_alquiler&orden=asc#listado"><img border="0" src="<?php echo  $_SESSION['rutaimg'];?>asc_azul.gif" align="absmiddle" /></a>&nbsp;<a href="index.php?id=<?php echo  $_GET['id'] ;?>&campo=precio_alquiler&orden=desc#listado"><img border="0" src="<?php echo  $_SESSION['rutaimg'];?>desc_azul.gif" align="absmiddle" /></a>
			</div>
			<br clear="all" />
		</div>	
		<br  />	
...
?>
			<?php
			// Datos de paginación
			echo $_SESSION['display_pages_busq_inmuebles_clientes'];
			echo $_SESSION['display_menu_pages_busq_inmuebles_clientes'];
			?>
			<br /><br />
			<table style="border:1px solid #004000" width="90%" cellpadding="1" cellspacing="1" align="center">
			<tr class="titulo_tabla"><td colspan="9">INMUEBLES NO ASIGNADOS AL CLIENTE</td></tr>
...
?>
				...
				<td><a target="_blank" href="../../inmuebles/editar.php?id=<?php echo  $todo['id_inmueble'];?>"><img src="<?php echo $_SESSION['rutaimg'];?>editar.gif" title="Editar" border="0" align="absmiddle"></a></td>
				<td><a href="insertar.php?id=<?php echo  $_GET['id'];?>&inmueble=<?php echo  $todo['id_inmueble'];?>"><img src="<?php echo $_SESSION['rutaimg'];?>nopublicar.gif" title="Asignar" border="0" align="absmiddle"></a></td>
				</tr>
<?php
