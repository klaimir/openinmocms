		...
		<div style="float:left; margin:0 auto; text-align:left; width:100%;">
			...
			<input class="campo_texto_blocked" readonly="readonly" style="margin-left:15px;" name="direccion_vivienda" id="direccion_vivienda" type="text" size="60" title="Dirección vivienda" value="<?php if($_POST['direccion_vivienda']) echo $_POST['direccion_vivienda'];  else echo $row_consulta['direccion_vivienda']; ?>" >
		</div>