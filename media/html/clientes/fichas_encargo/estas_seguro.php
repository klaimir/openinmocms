		...
		<p  align="justify"><img src="<?php echo  $_SESSION['rutaimg'];?>pregunta.gif" align="absmiddle">&nbsp;&nbsp;&iquest;Est&aacute;s seguro de que deseas eliminar la ficha de encargo del inmueble seleccionado?</p>
		<p align="center"><img align="absmiddle" src="<?php echo $_SESSION['rutaimg']; ?>si.png">&nbsp;<a href="borrar.php?id_ficha_encargo=<?php echo  $_GET['id_ficha_encargo'];?>&inmueble=<?php echo $_GET['inmueble']; ?>&cliente=<?php echo $_GET['id']; ?>">Si</a>&nbsp;&nbsp;&nbsp;&nbsp;<img align="absmiddle" src="<?php echo $_SESSION['rutaimg']; ?>no.png">&nbsp;<a href="index.php?id=<?php echo $_GET['id']; ?>&inmueble=<?php echo $_GET['inmueble']; ?>">No</a></p>
		<!--  Navegacion -->
		<p align="right">
