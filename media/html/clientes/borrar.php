		...
		<?php
			// Control de errores
			if($_SESSION['hayerroresborrarcliente'])
			{
	?>
				<div class="titulo_errores"><strong>Informe de errores</strong> &nbsp;| &nbsp;<?php echo  count($_SESSION['erroresborrarcliente']); ?> error (es) encontrado(s)</div>
				<div class="detalle_errores">
				<ul class="lista_errores">
	<?php
				foreach($_SESSION['erroresborrarcliente'] as $error)
				{
	?>		
