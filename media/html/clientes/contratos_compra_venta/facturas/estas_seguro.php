		...
		&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<a href="../editar.php?id_contrato_compra_venta=<?php echo  $_GET['contrato_compra_venta']; ?>&id=<?php echo  $_GET['id']; ?>&inmueble=<?php echo  $_GET['inmueble']; ?>">Editar</a>
		&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<span class="sin_enlace">Borrar factura</span>
		</div>
        <p align="justify" class="titulo_seccion">Clientes</p>
		<p  align="justify"><img src="<?php echo  $_SESSION['rutaimg'];?>pregunta.gif" align="absmiddle">&nbsp;&nbsp;&iquest;Est&aacute;s seguro de que deseas eliminar el contrato de compra-venta del inmueble seleccionado?</p>
		<p align="center"><img align="absmiddle" src="<?php echo $_SESSION['rutaimg']; ?>si.png">&nbsp;<a href="borrar.php?contrato_compra_venta=<?php echo  $_GET['contrato_compra_venta'];?>&inmueble=<?php echo $_GET['inmueble']; ?>&cliente=<?php echo $_GET['id']; ?>">Si</a>&nbsp;&nbsp;&nbsp;&nbsp;<img align="absmiddle" src="<?php echo $_SESSION['rutaimg']; ?>no.png">&nbsp;<a href="../editar.php?id_contrato_compra_venta=<?php echo  $_GET['contrato_compra_venta']; ?>&id=<?php echo  $_GET['id']; ?>&inmueble=<?php echo  $_GET['inmueble']; ?>">No</a></p>
		<!--  Navegacion -->
		<p align="right">
