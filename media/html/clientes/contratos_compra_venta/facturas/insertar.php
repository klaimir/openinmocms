		...
		{
			// Control de errores
			if($_SESSION['hayerroresinsertarfacturacontratocompraventa'])
			{
	?>
				<div class="titulo_errores"><strong>Informe de errores</strong> &nbsp;| &nbsp;<?php echo  count($_SESSION['erroresinsertarfacturacontratocompraventa']); ?> error(es) encontrado(s)</div>
				<div class="detalle_errores">
				<ul class="lista_errores">
	<?php
				foreach($_SESSION['erroresinsertarfacturacontratocompraventa'] as $error)
				{
	?>		
