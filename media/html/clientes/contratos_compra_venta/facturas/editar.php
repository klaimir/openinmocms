		...
		<div class="regla_horizontal_superior">
			...
			<div style="float:right; padding-top:4px;">
				<a href="../editar.php?id_contrato_compra_venta=<?php echo  $_GET['contrato_compra_venta']; ?>&id=<?php echo  $_GET['id']; ?>&inmueble=<?php echo  $_GET['inmueble']; ?>"><img border="0" src="<?php echo  $_SESSION['rutaimg'];?>volver.gif" align="absmiddle"></a>&nbsp;&nbsp;<a href="../editar.php?id_contrato_compra_venta=<?php echo  $_GET['contrato_compra_venta']; ?>&id=<?php echo  $_GET['id']; ?>&inmueble=<?php echo  $_GET['inmueble']; ?>">Volver</a>
			</div>			
		</div>
		<br clear="all" />
		<?php
		...
		{
			// Control de errores
			if($_SESSION['hayerroreseditarfacturacontratocompraventa'])
			{
	?>
				<div class="titulo_errores"><strong>Informe de errores</strong> &nbsp;| &nbsp;<?php echo  count($_SESSION['erroreseditarfacturacontratocompraventa']); ?> error(es) encontrado(s)</div>
				<div class="detalle_errores">
				<ul class="lista_errores">
	<?php
				foreach($_SESSION['erroreseditarfacturacontratocompraventa'] as $error)
				{
	?>		
	...
	<?php
		...
		<form action=""  name="editar" id="editar" method="post" enctype="multipart/form-data">
			<?php include('form_factura_contrato_compra_venta.php'); ?>
		</form>
		<br clear="all" /><br  />
