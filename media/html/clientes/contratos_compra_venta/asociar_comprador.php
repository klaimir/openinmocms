		...
		&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<span class="sin_enlace">Asociar comprador</span>
		</div>
	...
	<?php
		...
		<center>
			<span>Seleccione el comprador del inmueble:</span>
			<select id="cliente_comprador" name="cliente_comprador" class="campo_texto" onchange="modificado=true" style="margin-left:10px;">
				<option value="" <?php if ($_POST) { if ($_POST['cliente_comprador'] == '') echo "selected"; } ?>>Seleccione comprador ...</option>
			<?php
				do
				{
			?>
		...
		<p align="center">
        	<!-- Botón insertar -->	
			<a href="#" onclick="document.insertar.submit();return false"><img id="boton_inserta_bd" alt="Insertar en BD" name="boton_inserta_bd" border="0" src="<?php echo  $_SESSION['rutaimg'];?>insertar.gif" align="absmiddle" /></a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="document.insertar.submit();return false">Asociar comprador</a>	
        	<!-- Botón resetear -->	
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
