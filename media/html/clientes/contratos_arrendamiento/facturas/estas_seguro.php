		...
		<p align="center"><img align="absmiddle" src="<?php echo $_SESSION['rutaimg']; ?>si.png">&nbsp;<a href="borrar.php?contrato_arrendamiento=<?php echo  $_GET['contrato_arrendamiento'];?>&inmueble=<?php echo $_GET['inmueble']; ?>&cliente=<?php echo $_GET['id']; ?>">Si</a>&nbsp;&nbsp;&nbsp;&nbsp;<img align="absmiddle" src="<?php echo $_SESSION['rutaimg']; ?>no.png">&nbsp;<a href="../editar.php?id_contrato_arrendamiento=<?php echo  $_GET['contrato_arrendamiento']; ?>&id=<?php echo  $_GET['id']; ?>&inmueble=<?php echo  $_GET['inmueble']; ?>">No</a></p>
		<!--  Navegacion -->
		<p align="right">
