		...
		&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<span class="sin_enlace">Informe por provincia</span></div>
		...
		<img src="<?php echo  $_SESSION['rutaimg'];?>pieplot.jpg" align="absmiddle" />&nbsp;&nbsp;<a href="generar_diagrama_provincias.php?tipo_diagrama=pie" target="_blank">Generar diagrama (Cuñas)</a>
		<br  /><br  />
		<img src="<?php echo  $_SESSION['rutaimg'];?>diagrama.png" align="absmiddle" />&nbsp;&nbsp;<a href="generar_diagrama_provincias.php?tipo_diagrama=plot" target="_blank">Generar diagrama (Barras)</a>
		<br  /><br  />
		<img src="<?php echo  $_SESSION['rutaimg'];?>pdf.gif" align="absmiddle" />&nbsp;&nbsp;<a href="generar_diagrama_provincias.php?tipo_diagrama=pdf" target="_blank">Generar diagramas (PDF)</a>	
		<!--  Navegacion -->	
		<p align="right">
