		...
		&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<span class="sin_enlace">Informe por regiones</span></div>
	...
	?>                
        <form action="" name="formulario" id="formulario" method="post" enctype="multipart/form-data">
			...
			<select id="provincia" name="provincia" class="campo_texto" style="float:left; margin-left:10px;">
			...
			<span style="text-align:left; float:left; margin-left:20px;">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<!-- Botón resetear -->	
				<a href="<?php echo obtenerURLactual();?>" onclick="document.getElementById('formulario').reset(); document.getElementById('provincia').value=''; document.formulario.submit();return false" ><img src="<?php echo  $_SESSION['rutaimg'];?>no.png" alt="Limpiar filtro" border="0" align="absmiddle" /></a>&nbsp;&nbsp;<a href="<?php echo obtenerURLactual();?>" onclick="document.getElementById('formulario').reset(); document.getElementById('provincia').value=''; document.formulario.submit();return false">Limpiar filtro</a>
			</span>
		</form>	
		<br clear="all"  /><br  />
		...
		<div style="width:100%; padding-bottom:2px; border-bottom:1px solid #666666; color:#003366">
			...
			?>
				<div style="width:70%; float:right; text-align:right">
					<img src="<?php echo  $_SESSION['rutaimg'];?>pieplot.jpg" align="absmiddle" />&nbsp;&nbsp;<a href="generar_diagrama_regiones.php?provincia=<?php echo  $_POST['provincia'];?>&region=<?php echo  $_POST['region'];?>&poblacion=<?php echo  $_POST['poblacion'];?>&tipo_diagrama=pie" target="_blank">Generar diagrama (Cuñas)</a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<img src="<?php echo  $_SESSION['rutaimg'];?>diagrama.png" align="absmiddle" />&nbsp;&nbsp;<a href="generar_diagrama_regiones.php?provincia=<?php echo  $_POST['provincia'];?>&region=<?php echo  $_POST['region'];?>&poblacion=<?php echo  $_POST['poblacion'];?>&tipo_diagrama=plot" target="_blank">Generar diagrama (Barras)</a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<img src="<?php echo  $_SESSION['rutaimg'];?>pdf.gif" align="absmiddle" />&nbsp;&nbsp;<a href="generar_diagrama_regiones.php?provincia=<?php echo  $_POST['provincia'];?>&region=<?php echo  $_POST['region'];?>&poblacion=<?php echo  $_POST['poblacion'];?>&tipo_diagrama=pdf" target="_blank">Generar diagramas (PDF)</a>		
				</div>
			<?php
			}
			?>
...
?>
			<?php
			// Datos de paginación
			echo $_SESSION['display_pages_busq_informes_regiones'];
			echo $_SESSION['display_menu_pages_busq_informes_regiones'];
			?>
			<br /><br />
