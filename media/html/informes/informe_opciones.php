		...
		&nbsp;&nbsp;<img src="<?php echo  $_SESSION['rutaimg'];?>flecha2.png" align="absmiddle" />&nbsp;&nbsp;<span class="sin_enlace">Informe por opciones</span></div>
		...
		<div style="width:100%; padding-bottom:2px; border-bottom:1px solid #666666; color:#003366">
			...
			?>
				<div style="width:70%; float:right; text-align:right">
					<img src="<?php echo  $_SESSION['rutaimg'];?>pieplot.jpg" align="absmiddle" />&nbsp;&nbsp;<a href="generar_diagrama_opciones.php?provincia=<?php echo  $_POST['provincia'];?>&region=<?php echo  $_POST['region'];?>&poblacion=<?php echo  $_POST['poblacion'];?>&zona=<?php echo  $_POST['zona'];?>&tipo_diagrama=pie" target="_blank">Generar diagrama (Cuñas)</a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<img src="<?php echo  $_SESSION['rutaimg'];?>diagrama.png" align="absmiddle" />&nbsp;&nbsp;<a href="generar_diagrama_opciones.php?provincia=<?php echo  $_POST['provincia'];?>&region=<?php echo  $_POST['region'];?>&poblacion=<?php echo  $_POST['poblacion'];?>&zona=<?php echo  $_POST['zona'];?>&tipo_diagrama=plot" target="_blank">Generar diagrama (Barras)</a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<img src="<?php echo  $_SESSION['rutaimg'];?>pdf.gif" align="absmiddle" />&nbsp;&nbsp;<a href="generar_diagrama_opciones.php?provincia=<?php echo  $_POST['provincia'];?>&region=<?php echo  $_POST['region'];?>&poblacion=<?php echo  $_POST['poblacion'];?>&zona=<?php echo  $_POST['zona'];?>&tipo_diagrama=pdf" target="_blank">Generar diagramas (PDF)</a>		
				</div>
			<?php
			}
			?>
...
?>
			<?php
			// Datos de paginación
			echo $_SESSION['display_pages_busq_informes_opciones'];
			echo $_SESSION['display_menu_pages_busq_informes_opciones'];
			?>
			<br /><br />
